...
with open(file_to_save, "w") as txt_file:
    ...
    for county_name in county_votes:
        ...
        if (c_votes > county_vote_count and county_vote_percentage > county_winning_percentage) :
            county_vote_count = c_votes
    ...
    county_results = (
        f"-------------------------\n"
        f"County with the Highest Voter Turnout: {county_largest_turnout}\n"
        f"Votes Counted: {county_vote_count:,}\n"
        f"Percentage of total Counties: {county_winning_percentage:.1f}%\n"
        f"-------------------------\n")
